...
action_space = gym.spaces.box.Box(low = np.array([-5]), high = np.array([5]), dtype=np.float32) # Rotation,Acceleration , Braking (Deceleration)
...
class TestGame(Widget):
    ...
    def serve_car(self):
        ...
        self.testcar.velocity = Vector(5, 0)
    ...
    def get_screen(self,center_x,center_y,angle):
        ...
        path=os.path.normpath("C:\\Users\\lokesh\\Desktop\\EVA-vision\\Phase -2\\Assignment-10\\Assgn-7 files\\images\\MASK1.png")
    ...
    def update(self, dt):
        ...
        done_bool = 0.0 if episode_timesteps + 1 == 5000 else float(done)
